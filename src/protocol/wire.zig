...
pub fn exitCode(err: anyerror) u8 {
    return switch (err) {
        ...
        error.UnsupportedLanguage, error.InternalPath, error.BinaryFile, error.NotUtf8, error.EmptyPattern, error.UseSymbolToolsForSource, error.InvalidLineRange, error.LineOutOfRange, error.NoSymbolInRange => 18,
